                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="check-and-pass">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <a href="{{ route('password.request') }}" class="lost-pass">{{ __('ui.Password dimenticata?')}}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="button">
                            ...
                            <p class="outer-link">{{ __('ui.Non hai un account?')}} <a href="{{ route('register') }}">{{ __('ui.Registrati ora')}}</a>
                            </p>
                        </form>
                    </div>
                </div>
