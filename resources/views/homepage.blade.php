                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
                    <div class="hero-text text-center">
                        ...
                        <div class="section-heading">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".5s">{{ __('ui.Compra e Vendi da macchine usate a telefoni e computer,')}}
                                <br>{{ __('ui.oppure cerca proprietà, lavori e altro.')}} </p>
                            </div>
                            <!-- End Search Form -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="section-title align-center gray-bg">
                                    ...
                                    <p class="wow fadeInUp" data-wow-delay=".6s">
                                        {{ __('ui.Esistono molte varianti dei passaggi di TheLovendo disponibile, ma la maggior parte ha subito alterazioni in qualche forma.')}} </p>
                                    </div>
                                </div>
                            </div>
