<div class="dashboard-sidebar">
    ...
    <div class="dashboard-menu">
        <ul>
            <li><a class="{{ request()->routeIs('users.dashboard') ? 'active' : '' }}"
                    href="{{ route('users.dashboard') }}"><i class="lni lni-dashboard"></i> Dashboard</a></li>
            <li><a class="{{ request()->routeIs('users.profile_settings') ? 'active' : '' }}"
                    href="{{ route('users.profile_settings') }}"><i class="lni lni-pencil-alt"></i>
            ...
            @if (auth()->user()->is_revisor)
                <li><a class="{{ request()->routeIs('revisor.index') ? 'active' : '' }}"
                        href="{{ route('revisor.index') }}"><i class="lni lni-write"></i> Annunci da revisionare
                        {{ $articles_to_check_count ?? '' }}</a></li>
            @endif
        </ul>
    </div>
</div>
